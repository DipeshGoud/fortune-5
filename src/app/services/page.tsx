...
const servicesData: ServiceItem[] = [
  ...
  },
  {
    ...
    category: "CORPORATE",
    icon: Users,
    img: "/services/employee-benefit-policy.png",
  ...
  },
  {
    ...
    category: "CORPORATE",
    icon: HardHat,
    img: "/services/contractor-all-risk-insurance.jpg",
  ...
  },
  {
    ...
    category: "CORPORATE",
    icon: Scale,
    img: "/services/liability-insurance.png",
  ...
  },
  {
    ...
    category: "CORPORATE",
    icon: Building,
    img: "/services/office-comprehensive-package-policy.png",
  ...
  },
  {
    ...
    category: "CORPORATE",
    icon: Store,
    img: "/services/shopkeeper-all-risk-insurance.png",
          ...
          <div className="relative w-full overflow-hidden py-3">
            ...
            >
              {[
                ...
                { name: "HDFC ERGO", logo: "/partners/hdfc-ergo.png" },
                { name: "Digit General", logo: "/partners/digit-insurance.png" },
                { name: "Tata AIG", logo: "/partners/tata-aig.png" },
                { name: "Oriental Insurance", logo: "/partners/oriental-insurance.png" },
                { name: "New India Assurance", logo: "/partners/new-india-assurance.png" },
                { name: "Bajaj Allianz Life", logo: "/partners/bajaj-life.png" },
                { name: "HDFC Life", logo: "/partners/hdfc-life.png" },
                { name: "Tata AIA Life", logo: "/partners/tata-aia-life.png" },
                { name: "ICICI Prudential Life", logo: "/partners/icici-prudential.png" },
