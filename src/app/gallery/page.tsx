  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#F9F8F6] text-[#01327a] selection:bg-amber-100 selection:text-amber-900">
      ...
      <section className="relative isolate overflow-hidden bg-[#01327a] pt-[148px] sm:pt-[166px] lg:pt-[182px] pb-20 sm:pb-24 lg:pb-28">
        ...
        />
        <div className="absolute -left-24 top-16 h-[30rem] w-[30rem] rounded-full bg-[#C59B27]/10 blur-2xl transform-gpu pointer-events-none" />
        <div className="absolute -right-32 -top-10 h-[36rem] w-[36rem] rounded-full border border-[#C59B27]/10 pointer-events-none" />
        <div className="absolute right-[-5rem] top-24 h-[24rem] w-[24rem] rounded-full border border-white/5 pointer-events-none" />
        ...
        <div className="relative mx-auto w-full max-w-[1480px] px-5 sm:px-8 lg:px-10 xl:px-12 grid grid-cols-1 lg:grid-cols-[1.08fr_0.92fr] gap-10 lg:gap-8 xl:gap-12 items-center">
          ...
          <ScrollReveal variant="fadeUp" className="w-full">
            <div className="max-w-3xl">
              <nav
                ...
                className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3.5 py-1.5 backdrop-blur-xs"
              >
                <Link
                  href="/"
                  prefetch={false}
              ...
              <div className="mt-7 flex flex-wrap items-center gap-3">
                <a
                  href="#archive"
                  className="group inline-flex items-center gap-2.5 rounded-full bg-[#F5D77F] px-6 py-3.5 text-xs font-extrabold tracking-[0.14em] text-[#01327a] uppercase shadow-[0_10px_30px_rgba(197,155,39,0.25)] transition hover:bg-white cursor-pointer"
                >
                  Explore archive
                ...
                <Link
                  href="/about"
                  prefetch={false}
                  className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-6 py-3.5 text-xs font-extrabold tracking-[0.14em] text-white uppercase transition hover:border-[#F5D77F]/50 hover:text-[#F5D77F]"
                >
                  Our legacy
          ...
          <ScrollReveal variant="fadeLeft" delay={0.1} className="w-full">
            <div className="relative mx-auto w-full max-w-[520px] lg:ml-auto">
              ...
              <div className="absolute -bottom-4 -right-4 hidden h-24 w-24 rounded-2xl border border-[#C59B27]/20 bg-[#C59B27]/10 sm:block" />
              ...
              <div className="relative grid grid-cols-[1.35fr_0.85fr] gap-3 sm:gap-4 p-3 sm:p-4">
                ...
                <div className="relative overflow-hidden rounded-[1.6rem] border border-white/10 bg-slate-900 shadow-2xl">
                  <div className="relative aspect-[4/5] w-full">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#01327a]/85 via-transparent to-transparent pointer-events-none" />
                    <div className="absolute bottom-3 left-3 right-3 rounded-xl bg-[#01327a]/90 px-3 py-2.5 border border-white/10">
                ...
                <div className="flex flex-col gap-3 sm:gap-4">
                  ...
                  <Link href="/trophy" prefetch={false} className="group relative overflow-hidden rounded-[1.25rem] border border-white/10 hover:border-[#C59B27]/60 bg-white shadow-xl block transition-colors">
                    <div className="relative aspect-[4/3] w-full bg-[#F9F8F6]">
                      <Image
                        ...
                        decoding="async"
                        sizes="220px"
                        className="object-contain p-2 group-hover:scale-105 transition-transform duration-300 transform-gpu"
                      />
                    </div>
        ...
        <ScrollReveal variant="fadeUp" className="w-full">
          <div className="mx-auto grid w-full max-w-[1480px] grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-4">
            {heroStats.map((s) => (
              <div
                key={s.label}
                className="group rounded-2xl border border-slate-200/80 bg-white p-5 sm:p-6 shadow-[0_10px_30px_rgba(1,19,49,0.08)] transition-transform duration-200 hover:-translate-y-1 hover:border-[#C59B27]/30 transform-gpu"
              >
      ...
      <section className="relative overflow-hidden bg-[#01327a] py-10 sm:py-14">
        <div className="absolute inset-0 opacity-40">
          <div className="absolute -left-20 top-1/2 h-72 w-72 -translate-y-1/2 rounded-full bg-[#C59B27]/10 blur-2xl transform-gpu pointer-events-none" />
          <div className="absolute -right-20 bottom-0 h-72 w-72 rounded-full bg-white/[0.04] blur-2xl transform-gpu pointer-events-none" />
        </div>
        <ScrollReveal variant="fadeUp" className="w-full">
          <div className="relative mx-auto flex w-full max-w-[1480px] flex-col gap-6 px-5 sm:px-8 lg:px-10 xl:px-12 md:flex-row md:items-center md:justify-between">
            ...
            <Link
              href="/contact"
              prefetch={false}
              className="inline-flex shrink-0 items-center gap-2 rounded-full border border-[#C59B27]/30 bg-white/5 px-5 py-3 text-xs font-extrabold tracking-widest text-[#F5D77F] uppercase transition hover:bg-[#F5D77F] hover:text-[#01327a]"
            >
