...
const teamMembers: TeamMember[] = [
  {
    ...
    bio: "Pioneer in 3rd-generation risk advisory with 30+ years of experience structuring mega corporate insurance and reinsurance portfolios.",
    fullBio:
      "Kaushal Shah carries forward a 75-year family legacy in insurance advisory. Over three decades, he has pioneered bespoke risk management solutions for India's top corporate houses, infrastructure giants, and family offices. His hands-on approach to policy wording analysis and high-stakes claim advocacy ensures clients achieve maximum coverage efficiency and zero-friction claim settlements.",
    tags: ["Mega Corporate Risk", "Reinsurance Strategy", "Policy Wording Audit", "Family Legacy"],
    achievements: [
      "Settled ₹100Cr+ in complex industrial claims",
      "Advises 500+ corporate enterprises nationwide",
  ...
  },
  {
    ...
    fullBio:
      "Rahul leads the corporate risk practice at Fortune 5. With 18+ years in commercial insurance underwriting and brokerage, he specialises in mapping operational risks, designing Directors & Officers (D&O) liability frameworks, and negotiating competitive terms with leading national and international underwriters.",
  ...
  },
  {
    ...
    bio: "Former insurance advocate dedicated to securing zero-friction claim settlements and policy wording reviews.",
    fullBio:
      "Priya heads Fortune 5's dedicated claims resolution wing. An attorney by qualification with 15+ years of insurance litigation and claims experience, she ensures that Fortune 5 clients never navigate claims alone. Her team boasts a 99.4% claim settlement ratio across complex commercial and health policies.",
    tags: ["Claims Advocacy", "Arbitration & Legal", "Loss Minimisation", "Policy Audit"],
    achievements: [
      "99.4% claim settlement success rate",
      "Successfully litigated & settled 1,200+ claims",
      "Author of Commercial Claims Guidelines",
    ],
    linkedin: "https://linkedin.com",
  ...
  },
  {
    ...
    bio: "Architect of employee wellness programs and Keyman insurance solutions protecting over 50,000 lives.",
    fullBio:
    ...
    achievements: [
      "Manages 50,000+ insured corporate lives",
