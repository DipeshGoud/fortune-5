        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10 xl:gap-12">
          {solutions.map((item) => {
            ...
            return (
              <div
                key={item.id}
                className="group relative bg-white rounded-2xl p-8 sm:p-9 lg:p-10 border border-slate-200/80 shadow-lg hover:shadow-2xl hover:border-[#C59B27] transition-all duration-300 flex flex-col justify-between transform hover:-translate-y-2"
              >
