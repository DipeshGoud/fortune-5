  ...
  return (
    <section className="w-full py-16 sm:py-20 lg:py-24 bg-[#F9F8F6] relative overflow-hidden">
      <div className="w-full max-w-[1720px] 2xl:max-w-[1920px] 3xl:max-w-[2200px] 4xl:max-w-[2400px] mx-auto px-4 sm:px-8 lg:px-12 xl:px-16 2xl:px-16 3xl:px-20">
        ...
        {/* Section Header */}
        <ScrollReveal variant="fadeUp" duration={0.8} className="flex flex-col items-center justify-center text-center mb-16 sm:mb-20">
        ...
        <div className="relative w-full">
          ...
          <StaggerContainer
            staggerChildren={0.1}
            className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-8 sm:gap-10 lg:gap-4 relative z-10"
          >
            {steps.map((step, index) => {
              const IconComponent = step.icon;
              return (
                <StaggerItem key={step.id} variant="scaleUp">
